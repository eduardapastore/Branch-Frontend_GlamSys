                    ...
                    {["Dados Pessoais", "Vínculo e Função", "Pagamento", "Serviços"].map((status) => (
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-semibold transition ${
                                abaAtiva === status ? "font-bold text-amber-900 border-b-2 border-amber-500" : "hover:bg-gray-300"
                            }`}
                        >
                            {status}
                        </button>
                    ...
                    <div className='p-4 mt-4'>
                        <div className='flex gap-2 w-full'>
                            <div className='flex-1'>
                                ...
                                <select className="w-full mb-4 border border-gray-500 bg-transparent rounded-md p-2 text-sm">
